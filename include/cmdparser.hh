...
void cmdpars(int argc, char const* argv[], SimEnv& simenv){
  ...
  simenv._runhash = std::time(0);
	...
	desc.add_options() 
      ...
      (",h", po::value<precision_t>(&(simenv._storage_height))->required() ,"storage height")
      (",d", po::value<precision_t>(&(simenv._storage_diameter))->required(), "storage diameter")
      (",t", po::value<precision_t>(&(simenv._fluid_initemp))->required(), "initial temperature of fluid")
      ("tds0", po::value<precision_t>(&(simenv._timedurstate0))->required(), "time duration for state 0")
      ("tds1", po::value<precision_t>(&(simenv._timedurstate1))->required(), "time duration for state 1")
      ("tds2", po::value<precision_t>(&(simenv._timedurstate2))->required(), "time duration for state 2")
      ("tds3", po::value<precision_t>(&(simenv._timedurstate3))->required(), "time duration for state 3")
      ...
      ("epsilon", po::value<precision_t>(&(simenv._epsilon))->required(), "epsilon")
      ("uf", po::value<precision_t>(&(simenv._uf))->required(), "uf")
